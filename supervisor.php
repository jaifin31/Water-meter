...
<head>
    ...
    <style>
        ...
        table.table tr td {
            ...
            overflow: hidden;
            /* Hide content if it overflows the cell */
        }
...
<script>
        $(document).ready(function () {
            ...
            $(".add-new").click(function () {
                ...
                var row = '<tr>' +
                    '<td><input type="text" class="form-control" name="supername" id="supername"></td>' +
                    '<td><input type="text" class="form-control" name="superemail" id="superemail"></td>' +
                    '<td><input type="text" class="form-control" name="superphone" id="superphone"></td>' +
                    '<td><input type="text" class="form-control" name="areaname" id="areaname"></td>' +
