...
<script>
    $(document).ready(function () {
        ...
        $(".add-new").click(function () {
            ...
            var row = '<tr>' +
                '<td><input type="text" class="form-control" name="serialnum" id="serialnum"></td>' +
                '<td>' +
                '<select class="form-control" name="superid" diabled>' +
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" disabled>
                                            <option value="Jyothi Circle">Select User</option>
                                            <option value="Some Other Area">Jane</option>
                                            <option value="Some Other Area">Jane</option>
                                            <option value="Some Other Area">Jane</option>
                                            <option value="Some Other Area">Jane</option>
                                        </select>
                                    ...
                                    <td>
                                        <select class="form-control" disabled>
                                            <option value="Jyothi Circle">Select Supervisor</option>
                                            <option value="Some Other Area">Jane</option>
                                            <option value="Some Other Area">Jane</option>
                                            <option value="Some Other Area">Jane</option>
                                            <option value="Some Other Area">Jane</option>
